  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <ul class="me-auto mb-2 mb-lg-0 w-100" style="background-color: #e3f2fd;">
      <div class="container navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link bg-warning fw-bold" href="index.php">Главная</a>
        </li>
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body row justify-content-center">
            ...
            <div class="col-5 row justify-content-center py-2">
              <img src="assets/resources/index1.jpg" class="col-12">
            </div>

            <div class="col-6 fs-3">Муниципальное бюджетное дошкольное образовательное учреждение «Детский сад №34 «Ромашка» общеразвивающего вида с приоритетным осуществлением деятельности по художественно-эстетическому развитию детей» </div>
